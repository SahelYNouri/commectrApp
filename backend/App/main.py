...
app.add_middleware(
    ...
    allow_origins=["*"], # allows all origins to call backend APIS (for development, will be changed later to only allow frontend origin)
    allow_credentials=True, #allows cookies/ auth headers to be sent from the frontend
